...
public class SignupTwo extends JFrame implements ActionListener {
    ...
    SignupTwo(String formno) {
        ...
        gender.setBounds(100,310,150,30);
        add(gender);
        ...
        String[] educationCategory = {"Non-Graduation", "Graduation", "Post-Graduation", "Doctrate", "other"};
        ...
        ButtonGroup EAccout = new ButtonGroup();
        EAccout.add(eyes);
        EAccout.add(eno);
